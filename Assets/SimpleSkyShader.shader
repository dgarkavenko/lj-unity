...
////// Emissive:
                ...
                float3 node_5 = lerp((node_5_if_leA*node_8)+(node_5_if_leB*lerp(_Mid.rgb,_Bot.rgb,abs(node_7.g))),node_8,node_5_if_leA*node_5_if_leB);
                float3 emissive = saturate((1.0-(1.0-(tex2D(_Stars,TRANSFORM_TEX(node_7.rg, _Stars)).rgb*_Overbrightness))*(1.0-node_5)));
